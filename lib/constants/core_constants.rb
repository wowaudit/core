...
PREVENT_SKIP_TIMESTAMP = Time.parse("2024-08-30 09:30:00 +0200").to_i
...
HEADER = {
  live: [
    ...
    'city_of_threads_total',
    'city_of_threads_score',
    'the_stonevault_total',
    'the_stonevault_score',
    ...
    'quests_done_total',
    'dailies_done_total',
    'mists_of_tirna_scithe_total',
    'mists_of_tirna_scithe_score',
    'siege_of_boralus_total',
    'siege_of_boralus_score',
    'great_vault_slot_1',
    'great_vault_slot_2',
    'great_vault_slot_3',
    'great_vault_slot_4',
    ...
    'total_renown_score',
    'the_necrotic_wake_total',
    'the_necrotic_wake_score',
    'jewelry_sockets',
