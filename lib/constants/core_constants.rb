...
PREVENT_SKIP_TIMESTAMP = DateTime.parse("2026-08-15 11:45:00 +0200")
...
HEADER = {
  live: [
    ...
    'hero_crests',
    'windrunner_spire_total',
    'windrunner_spire_score',
    'maisara_caverns_total',
    'maisara_caverns_score',
    'algethar_academy_total',
    'algethar_academy_score',
    'nexuspoint_xenas_total',
    "nexuspoint_xenas_score",
    'magisters_terrace_total',
    'magisters_terrace_score',
    ...
    'quests_done_total',
    'dailies_done_total',
    'seat_of_the_triumvirate_total',
    'seat_of_the_triumvirate_score',
    'skyreach_total',
    'skyreach_score',
    'great_vault_slot_1',
    'great_vault_slot_2',
    ...
    'great_vault_slot_9',
    'amani_tribe_renown',
    'silvermoon_court_renown',
    'harati_renown',
    'the_singularity_renown',
    'total_renown_score',
    'pit_of_saron_total',
    'pit_of_saron_score',
    'voidforge_quest',
  ...
  classic_anniversary: [
    ...
    "profession_1",
    "profession_1_benefits",
    'finger_1_enchant_quality',
    'finger_1_enchant_name',
    'finger_2_enchant_quality',
    'finger_2_enchant_name',
    "profession_2",
    "profession_2_benefits",
    '2v2_rating',
    '2v2_season_played',
