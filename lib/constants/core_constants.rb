...
WCL_URL = "https://www.warcraftlogs.com:443/v1/parses/character/{name}/{realm}/{region}?zone={zone}&metric={metric}&partition={partition}&timeframe=historical&api_key=#{WCL_KEY}"
