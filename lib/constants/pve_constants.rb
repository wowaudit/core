...
VALID_RAIDS = {
  ...
  classic_progression: [
    {"name"=>"Mogu'shan Vaults", "days"=>[0, 1, 2, 3, 4, 5, 6], "id"=>nil, "encounters"=>[{"id"=>nil, "name"=>"The Stone Guard", "raid_ids"=>{"raid_finder"=>[], "normal"=>[], "heroic"=>[], "mythic"=>[]}}, {"id"=>nil, "name"=>"Feng the Accursed", "raid_ids"=>{"raid_finder"=>[], "normal"=>[6984], "heroic"=>[7918], "mythic"=>[]}}, {"id"=>nil, "name"=>"Gara'jal the Spiritbinder", "raid_ids"=>{"raid_finder"=>[], "normal"=>[6985], "heroic"=>[7920], "mythic"=>[]}}, {"id"=>nil, "name"=>"The Spirit Kings", "raid_ids"=>{"raid_finder"=>[], "normal"=>[], "heroic"=>[], "mythic"=>[]}}, {"id"=>nil, "name"=>"Elegon", "raid_ids"=>{"raid_finder"=>[], "normal"=>[6987], "heroic"=>[6798], "mythic"=>[]}}, {"id"=>nil, "name"=>"Will of the Emperor", "raid_ids"=>{"raid_finder"=>[], "normal"=>[6988], "heroic"=>[], "mythic"=>[]}}]},
    {"name"=>"Heart of Fear", "days"=>[], "id"=>nil, "encounters"=>[{"id"=>nil, "name"=>"Imperial Vizier Zor'lok", "raid_ids"=>{"raid_finder"=>[], "normal"=>[6991], "heroic"=>[6802], "mythic"=>[]}}, {"id"=>nil, "name"=>"Blade Lord Ta'yak", "raid_ids"=>{"raid_finder"=>[], "normal"=>[6992], "heroic"=>[6804], "mythic"=>[]}}, {"id"=>nil, "name"=>"Garalon", "raid_ids"=>{"raid_finder"=>[], "normal"=>[6993], "heroic"=>[6806], "mythic"=>[]}}, {"id"=>nil, "name"=>"Wind Lord Mel'jarak", "raid_ids"=>{"raid_finder"=>[], "normal"=>[6994], "heroic"=>[6808], "mythic"=>[]}}, {"id"=>nil, "name"=>"Amber-Shaper Un'sok", "raid_ids"=>{"raid_finder"=>[], "normal"=>[6995], "heroic"=>[6810], "mythic"=>[]}}, {"id"=>nil, "name"=>"Grand Empress Shek'zeer", "raid_ids"=>{"raid_finder"=>[], "normal"=>[6996], "heroic"=>[6812], "mythic"=>[]}}]},
    {"name"=>"Terrace of Endless Spring", "days"=>[], "id"=>nil, "encounters"=>[{"id"=>nil, "name"=>"Protectors of the Endless", "raid_ids"=>{"raid_finder"=>[], "normal"=>[6997], "heroic"=>[], "mythic"=>[]}}, {"id"=>nil, "name"=>"Tsulong", "raid_ids"=>{"raid_finder"=>[], "normal"=>[6998], "heroic"=>[], "mythic"=>[]}}, {"id"=>nil, "name"=>"Lei Shi", "raid_ids"=>{"raid_finder"=>[], "normal"=>[6999], "heroic"=>[], "mythic"=>[]}}, {"id"=>nil, "name"=>"Sha of Fear", "raid_ids"=>{"raid_finder"=>[], "normal"=>[7000], "heroic"=>[], "mythic"=>[]}}]}
  ],
}
