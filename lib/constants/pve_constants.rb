...
VALID_RAIDS = {
  ...
  classic_progression: [
    ...
    {"name"=>"Throne of Thunder", "days"=>[0, 1, 2, 3, 4, 5, 6], "id"=>nil, "encounters"=>[{"id"=>nil, "name"=>"Jin'rokh the Breaker", "raid_ids"=>{"raid_finder"=>[8141], "normal"=>[8143], "heroic"=>[8145]}}, {"id"=>nil, "name"=>"Horridon", "raid_ids"=>{"raid_finder"=>[8148], "normal"=>[8150], "heroic"=>[8152]}}, {"id"=>nil, "name"=>"Council of Elders", "raid_ids"=>{"raid_finder"=>[8153], "normal"=>[8155], "heroic"=>[8157]}}, {"id"=>nil, "name"=>"Tortos", "raid_ids"=>{"raid_finder"=>[8158], "normal"=>[8160], "heroic"=>[8161]}}, {"id"=>nil, "name"=>"Megaera", "raid_ids"=>{"raid_finder"=>[8163], "normal"=>[8165], "heroic"=>[8167]}}, {"id"=>nil, "name"=>"Ji-Kun", "raid_ids"=>{"raid_finder"=>[8168], "normal"=>[8169, 8170], "heroic"=>[8172]}}, {"id"=>nil, "name"=>"Durumu the Forgotten", "raid_ids"=>{"raid_finder"=>[8173], "heroic"=>[8177]}}, {"id"=>nil, "name"=>"Primordius", "raid_ids"=>{"raid_finder"=>[8178], "heroic"=>[8180]}}, {"id"=>nil, "name"=>"Dark Animus", "raid_ids"=>{"raid_finder"=>[8183], "heroic"=>[8187]}}, {"id"=>nil, "name"=>"Iron Qon", "raid_ids"=>{"raid_finder"=>[8188], "heroic"=>[8192]}}, {"id"=>nil, "name"=>"Twin Empyreans", "raid_ids"=>{}}, {"id"=>nil, "name"=>"Lei Shen", "raid_ids"=>{"raid_finder"=>[8198], "heroic"=>[8201]}}, {"id"=>nil, "name"=>"Ra-den", "raid_ids"=>{"normal"=>[14128], "heroic"=>[8256, 14129]}}]}
  ],
}
