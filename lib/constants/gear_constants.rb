...
SPARK_RECIPE_NAME_TO_ITEM_ID = {
  ...
  "Enchant Boots - Cavalry's March" => { id: 50475, profession: 'Enchanting' },
  "Enchant Boots - Defender's March" => { id: 50477, profession: 'Enchanting' },
  "Enchant Boots - Scout's March" => { id: 50476, profession: 'Enchanting' },
  "Enchant Bracer - Chant of Armored Avoidance" => { id: 50521, profession: 'Enchanting' },
  "Enchant Bracer - Chant of Armored Leech" => { id: 50523, profession: 'Enchanting' },
  "Enchant Bracer - Chant of Armored Speed" => { id: 50525, profession: 'Enchanting' },
  "Enchant Chest - Council's Intellect" => { id: 50503, profession: 'Enchanting' },
  "Enchant Chest - Crystalline Radiance" => { id: 50504, profession: 'Enchanting' },
  "Enchant Chest - Oathsworn's Strength" => { id: 50505, profession: 'Enchanting' },
  "Enchant Chest - Stormrider's Agility" => { id: 50501, profession: 'Enchanting' },
  "Enchant Cloak - Chant of Burrowing Rapidity" => { id: 50531, profession: 'Enchanting' },
  "Enchant Cloak - Chant of Leeching Fangs" => { id: 50529, profession: 'Enchanting' },
  "Enchant Cloak - Chant of Winged Grace" => { id: 50527, profession: 'Enchanting' },
  "Enchant Tool - Algari Deftness" => { id: 50506, profession: 'Enchanting' },
  "Enchant Tool - Algari Finesse" => { id: 50507, profession: 'Enchanting' },
  "Enchant Tool - Algari Ingenuity" => { id: 50508, profession: 'Enchanting' },
  "Enchant Tool - Algari Perception" => { id: 50509, profession: 'Enchanting' },
  "Enchant Tool - Algari Resourcefulness" => { id: 50510, profession: 'Enchanting' },
  "Enchant Ring - Radiant Critical Strike" => { id: 50479, profession: 'Enchanting' },
  "Enchant Ring - Radiant Haste" => { id: 50481, profession: 'Enchanting' },
  "Enchant Ring - Radiant Mastery" => { id: 50483, profession: 'Enchanting' },
  "Enchant Ring - Radiant Versatility" => { id: 50485, profession: 'Enchanting' },
  "Enchant Ring - Cursed Critical Strike" => { id: 50532, profession: 'Enchanting' },
  "Enchant Ring - Cursed Haste" => { id: 50533, profession: 'Enchanting' },
  "Enchant Ring - Cursed Mastery" => { id: 50534, profession: 'Enchanting' },
  "Enchant Ring - Cursed Versatility" => { id: 50535, profession: 'Enchanting' },
  "Enchant Weapon - Authority of Air" => { id: 50486, profession: 'Enchanting' },
  "Enchant Weapon - Authority of Fiery Resolve" => { id: 50487, profession: 'Enchanting' },
  "Enchant Weapon - Authority of Radiant Power" => { id: 50488, profession: 'Enchanting' },
  "Enchant Weapon - Authority of Storms" => { id: 50511, profession: 'Enchanting' },
  "Enchant Weapon - Authority of the Depths" => { id: 50536, profession: 'Enchanting' },
