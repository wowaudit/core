...
RESHII_WRAPS_BOOTS = (243305..243308).to_a
...
TIER_ITEMS_BY_SLOT = {
  'head' => [
    # Manaforge Omega
    237646, 237628, 237682, 237709, 237718, 237664, 237619, 237637, 237691, 237673, 237700, 237655, 237610
  ],
  'shoulder' => [
    # Manaforge Omega
    237608, 237680, 237617, 237635, 237644, 237689, 237626, 237716, 237698, 237707, 237662, 237671, 237653
  ],
  'chest' => [
    # Manaforge Omega
    237622, 237631, 237685, 237712, 237640, 237649, 237676, 237721, 237667, 237694, 237703, 237613, 237658
  ],
  'hands' => [
    # Manaforge Omega
    237683, 237620, 237611, 237710, 237638, 237665, 237719, 237692, 237674, 237701, 237629, 237656, 237647
  ],
  'legs' => [
    # Manaforge Omega
    237618, 237636, 237645, 237717, 237708, 237609, 237681, 237627, 237654, 237663, 237699, 237690, 237672
  ],
}

TIER_ITEMS = TIER_ITEMS_BY_SLOT.values.flatten

LEGACY_TIER_CUTOFFS = { 1 => 'R', 681 => 'N', 694 => 'H', 707 => 'M' }
