...
SPARK_RECIPE_NAME_TO_ITEM_ID = {
  ...
  "Enchant Boots - Cavalry's March" => { id: 223618, profession: 'Enchanting' },
  "Enchant Boots - Defender's March" => { id: 223654, profession: 'Enchanting' },
  "Enchant Boots - Scout's March" => { id: 223651, profession: 'Enchanting' },
  "Enchant Bracer - Chant of Armored Avoidance" => { id: 223711, profession: 'Enchanting' },
  "Enchant Bracer - Chant of Armored Leech" => { id: 223717, profession: 'Enchanting' },
  "Enchant Bracer - Chant of Armored Speed" => { id: 223723, profession: 'Enchanting' },
  "Enchant Chest - Council's Intellect" => { id: 223684, profession: 'Enchanting' },
  "Enchant Chest - Crystalline Radiance" => { id: 223690, profession: 'Enchanting' },
  "Enchant Chest - Oathsworn's Strength" => { id: 223687, profession: 'Enchanting' },
  "Enchant Chest - Stormrider's Agility" => { id: 223681, profession: 'Enchanting' },
  "Enchant Cloak - Chant of Burrowing Rapidity" => { id: 223798, profession: 'Enchanting' },
  "Enchant Cloak - Chant of Leeching Fangs" => { id: 223735, profession: 'Enchanting' },
  "Enchant Cloak - Chant of Winged Grace" => { id: 223729, profession: 'Enchanting' },
  "Enchant Tool - Algari Deftness" => { id: 223693, profession: 'Enchanting' },
  "Enchant Tool - Algari Finesse" => { id: 223696, profession: 'Enchanting' },
  "Enchant Tool - Algari Ingenuity" => { id: 223699, profession: 'Enchanting' },
  "Enchant Tool - Algari Perception" => { id: 223702, profession: 'Enchanting' },
  "Enchant Tool - Algari Resourcefulness" => { id: 223705, profession: 'Enchanting' },
  "Enchant Ring - Radiant Critical Strike" => { id: 223660, profession: 'Enchanting' },
  "Enchant Ring - Radiant Haste" => { id: 223672, profession: 'Enchanting' },
  "Enchant Ring - Radiant Mastery" => { id: 223675, profession: 'Enchanting' },
  "Enchant Ring - Radiant Versatility" => { id: 223678, profession: 'Enchanting' },
  "Enchant Ring - Cursed Critical Strike" => { id: 223785, profession: 'Enchanting' },
  "Enchant Ring - Cursed Haste" => { id: 223788, profession: 'Enchanting' },
  "Enchant Ring - Cursed Mastery" => { id: 223791, profession: 'Enchanting' },
  "Enchant Ring - Cursed Versatility" => { id: 223794, profession: 'Enchanting' },
  "Enchant Weapon - Authority of Air" => { id: 223773, profession: 'Enchanting' },
  "Enchant Weapon - Authority of Fiery Resolve" => { id: 223776, profession: 'Enchanting' },
  "Enchant Weapon - Authority of Radiant Power" => { id: 223779, profession: 'Enchanting' },
  "Enchant Weapon - Authority of Storms" => { id: 223770, profession: 'Enchanting' },
  "Enchant Weapon - Authority of the Depths" => { id: 223782, profession: 'Enchanting' },
